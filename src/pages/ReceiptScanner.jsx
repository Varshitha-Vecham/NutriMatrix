...
function ReceiptScanner() {
  ...
  async function saveHistoryEdit(productId) {
    try {
      ...
      setTrackedProducts((current) => current.map((product) => product.id === productId ? { ...product, expiryDate: editingExpiry } : product))
